...
import { Globe, MessageCircle, Camera, ArrowRight } from "lucide-react";
    ...
    <footer className="bg-[#f0ede9] dark:bg-stone-900 w-full py-20 px-6 md:px-12 mt-20 border-t border-[#31032c]/5 transition-all">
      <div className="max-w-[1920px] mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 items-start">
        <div className="space-y-6">
          ...
          <p className="text-[#4f434b] dark:text-stone-300 text-sm leading-relaxed font-serif italic max-w-xs">
            Curating the world's most evocative gemstones since 1984. Our legacy
            is written in the refraction of every unique facet.
          </p>
        </div>

        <div className="flex flex-col gap-4 font-sans text-xs tracking-widest uppercase">
          <span className="text-[#31032c] dark:text-fuchsia-400 font-bold mb-2">
            Heritage Atélier
          </span>
          <Link
            to="/about"
            className="text-[#4f434b] dark:text-stone-300 hover:text-[#8f4c30] transition-colors"
          >
            Our Story
          </Link>
          <Link
        ...
        <div className="space-y-6">
          ...
          <p className="text-[#4f434b] dark:text-stone-300 text-xs leading-relaxed uppercase tracking-widest">
            Receive private invitations to seasonal curations and bespoke
            atélier arrivals.
          </p>
          {subscribed ? (
            ...
            <form
              ...
              className="relative border-b border-[#31032c] dark:border-white/20 py-2"
            >
              <input
              ...
              <button
                type="submit"
                className="absolute right-0 bottom-2 text-[#31032c] hover:text-[#8f4c30] cursor-pointer transition-colors"
      ...
      <div className="max-w-[1920px] mx-auto mt-16 pt-8 border-t border-[#31032c]/10 flex flex-col md:flex-row justify-between items-center gap-6">
        <p className="text-[#4f434b] dark:text-stone-400 text-[10px] tracking-[0.3em] uppercase">
          © 2026 RoshGems Digital Atélier. Indian Luxury Heritage. All rights
          reserved.
        </p>
        <div className="flex gap-8 text-[#31032c] dark:text-stone-400">
          <Globe className="h-5 w-5 cursor-pointer hover:text-[#8f4c30] transition-colors" />
          <MessageCircle className="h-5 w-5 cursor-pointer hover:text-[#8f4c30] transition-colors" />
          <Camera className="h-5 w-5 cursor-pointer hover:text-[#8f4c30] transition-colors" />
        </div>
      </div>
    </footer>
  );
